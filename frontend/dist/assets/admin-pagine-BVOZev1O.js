import{d as r,h as o}from"./api-CLZultR4.js";import{e as d}from"./admin-auth-B7eemFN8.js";function s(a){if(a==null)return"";const t=document.createElement("div");return t.textContent=a,t.innerHTML}async function c(){await d();const a=document.getElementById("logout-btn");a&&a.addEventListener("click",async e=>{e.preventDefault();try{await r()}catch{}window.location.href="admin-login.html"});const t=document.getElementById("pages-list");if(t)try{const e=await o(),i=Array.isArray(e.data)?e.data:[];if(!i.length){t.innerHTML='<p class="empty-state">Nessuna pagina. La gestione crea/modifica sarà disponibile in una prossima versione.</p>';return}t.innerHTML=`
