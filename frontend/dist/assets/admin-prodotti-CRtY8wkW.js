import{e as l,h as m}from"./api-CwRZMsSl.js";import{e as h}from"./admin-auth-BjFgki1z.js";function r(e){if(e==null)return"";const n=document.createElement("div");return n.textContent=e,n.innerHTML}async function u(){await h();const e=document.getElementById("products-table-wrap"),n=document.getElementById("logout-btn");if(n&&n.addEventListener("click",async a=>{a.preventDefault();try{await l()}catch{}window.location.href="admin-login.html"}),!!e)try{const a=await m({per_page:100}),o=Array.isArray(a.data)?a.data:[];if(!o.length){e.innerHTML='<p class="empty-state">Nessun prodotto. <a href="./admin-prodotto.html">Aggiungi il primo</a>.</p>';return}e.innerHTML=`
