import{e as r,v as i,w as l}from"./api-JfdcZMFN.js";import{e as c}from"./admin-auth-0_EEe6l0.js";function s(a){if(a==null)return"";const e=document.createElement("div");return e.textContent=a,e.innerHTML}async function u(){await c();const a=document.getElementById("logout-btn");a&&a.addEventListener("click",async n=>{n.preventDefault();try{await r()}catch{}window.location.href="admin-login.html"});const e=document.getElementById("inquiries-list");if(e)try{const n=await i({per_page:50}),d=Array.isArray(n.data)?n.data:[];if(!d.length){e.innerHTML='<p class="empty-state">Nessuna richiesta.</p>';return}e.innerHTML=`
