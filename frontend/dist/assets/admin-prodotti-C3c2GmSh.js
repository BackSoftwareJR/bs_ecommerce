import{d as l,f as m}from"./api-CLZultR4.js";import{e as u}from"./admin-auth-B7eemFN8.js";function r(e){if(e==null)return"";const n=document.createElement("div");return n.textContent=e,n.innerHTML}async function h(){await u();const e=document.getElementById("products-table-wrap"),n=document.getElementById("logout-btn");if(n&&n.addEventListener("click",async a=>{a.preventDefault();try{await l()}catch{}window.location.href="admin-login.html"}),!!e)try{const a=await m({per_page:100}),o=Array.isArray(a.data)?a.data:[];if(!o.length){e.innerHTML='<p class="empty-state">Nessun prodotto. <a href="./admin-prodotto.html">Aggiungi il primo</a>.</p>';return}e.innerHTML=`
